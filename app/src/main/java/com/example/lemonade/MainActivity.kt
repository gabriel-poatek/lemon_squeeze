    ...
    private fun setViewElements() {
        ...
        when(lemonadeState){
            ...
            textAction.setText(R.string.lemon_select)
                val drawable = ContextCompat.getDrawable(this, R.drawable.lemon_tree)
                lemonImage?.setImageDrawable(drawable)
            }
            squeeze -> {
                textAction.setText(R.string.lemon_squeeze)
                val drawable = ContextCompat.getDrawable(this, R.drawable.lemon_squeeze)
                lemonImage?.setImageDrawable(drawable)

            }
            drink -> {
                textAction.setText(R.string.lemon_drink)
                val drawable = ContextCompat.getDrawable(this, R.drawable.lemon_drink)
                lemonImage?.setImageDrawable(drawable)

            }
            restart -> {
                textAction.setText(R.string.lemon_empty_glass)
                val drawable = ContextCompat.getDrawable(this, R.drawable.lemon_restart)
                lemonImage?.setImageDrawable(drawable)
